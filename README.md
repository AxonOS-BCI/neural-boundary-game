...
[![Release](https://img.shields.io/badge/release-v1.9.8-brightgreen)](https://github.com/AxonOS-BCI/neural-boundary-game/releases/tag/v1.9.8)
[![Tag](https://img.shields.io/badge/tag-v1.9.8-brightgreen)](https://github.com/AxonOS-BCI/neural-boundary-game/tags)
...
[![Latest release](https://img.shields.io/badge/RELEASE-v1.9.8-7CFF4F?style=for-the-badge)](https://github.com/AxonOS-BCI/neural-boundary-game/releases/tag/v1.9.8)
...
The project is built from a clean v1.9.8 baseline: no `web-sys`, no `wasm-bindgen`, no `#[no_mangle]`, no browser-binding dependency surface, and no patched legacy glue.
...
This rewrites the remote `main` history. Use only when intentionally replacing the previous history with clean v1.9.8:
