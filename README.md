...
[![Release](https://img.shields.io/badge/release-v1.9.1-brightgreen)](https://github.com/AxonOS-BCI/neural-boundary-game/releases/tag/v1.9.1)
[![Tag](https://img.shields.io/badge/tag-v1.9.1-brightgreen)](https://github.com/AxonOS-BCI/neural-boundary-game/tags)
...
The project is built from a clean v1.9.1 baseline: no `web-sys`, no `wasm-bindgen`, no `#[no_mangle]`, no browser-binding dependency surface, and no patched legacy glue.
