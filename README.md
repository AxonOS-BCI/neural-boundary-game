...
[![Release](https://img.shields.io/badge/release-v1.8.2-brightgreen)](https://github.com/AxonOS-BCI/neural-boundary-game/releases/tag/v1.8.2)
[![Tag](https://img.shields.io/badge/tag-v1.8.2-brightgreen)](https://github.com/AxonOS-BCI/neural-boundary-game/tags)
...
The project is built from a clean v1.8.2 baseline: no `web-sys`, no `wasm-bindgen`, no `#[no_mangle]`, no browser-binding dependency surface, and no patched legacy glue.
...
This rewrites the remote `main` history. Use only when intentionally replacing the previous history with clean v1.8:
