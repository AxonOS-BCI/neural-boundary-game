...
# Neural Boundary Game v7.3.0 — Game Specification

**Canonical schema**: `neural-boundary-replay-v7.3.0`
...
Daily seed: FNV-1a 64-bit over `"NBG|7.3.0|YYYY-MM-DD|DAILY"` then one xorshift64star round.
