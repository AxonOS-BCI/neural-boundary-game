...
# Neural Boundary Game v7.9.812 — Game Specification

**Canonical schema**: `neural-boundary-replay-v7.9.812`
...
Daily seed: FNV-1a 64-bit over `"NBG|7.9.812|YYYY-MM-DD|DAILY"` then one xorshift64star round.
