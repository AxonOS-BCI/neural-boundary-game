...
# Neural Boundary Game v5.5.12 — Game Specification

**Canonical schema**: `neural-boundary-replay-v5.5.12`
...
Daily seed: FNV-1a 64-bit over `"NBG|5.5.12|YYYY-MM-DD|DAILY"` then one xorshift64star round.
